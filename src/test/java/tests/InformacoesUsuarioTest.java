...
public class InformacoesUsuarioTest {
    ...
    public void testAdicionarUmaInformacaoAdicionalDoUsuario(@Param(name = "tipo") String tipo, @Param(name = "contato") String contato, @Param(name = "mensagem") String mensagemEsperada) {
        ...
        // No campo de name "contac" digitar +5511944000044
    ...
    public void removerContatoDeUmUsuario() {
        ...
        String screenShotArquivo = "/home/srlusca/Imagens/test-report/taskit/EVIDÊNCIA" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
